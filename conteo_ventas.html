...
<body>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Conteo de Ventas</h1>
    ...
    <div class="container-fluid py-5">
            ...
            <div class="section-title">
                <h1 class="display-4">Formulario de Conteo de Ventas</h1>
            </div>
            <div id="info">
                <div class="row">
                    <div class="col-lg-4 py-0 py-lg-5">
                        ...
                        <h3 class="mb-3">Precio por unidad:</h3>
                        <h3 class="mb-3">Total de ventas:</h3>
                        
                    </div>
                    <div class="col-lg-4 py-0 py-lg-5">
                        <h3 class="mb-3">Mango</h3>
                        <h3 class="mb-3">20</h3>
                        <h3 class="mb-3">$65</h3>
                        <h3 class="mb-3">$1,300</h3>
