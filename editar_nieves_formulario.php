...
$sentencia = $conexion->prepare("SELECT nombre, categoria, estatus from nieves where id_nieve= ?");
...
<form action="actualizar_nieves.php" method="POST" class="formulario__register" onsubmit="return confirm('¿Seguro que quieres realizar los cambios?');">
    <div class="contenedor__todo">
        ...
        <input value="<?php echo isset($usuarios["nombre"]) ? $usuarios["nombre"] : ''; ?>" type="text" class="form-control bg-transparent p-4" name="nombre" placeholder="Edita el nombre" />
        <p class="help-block text-danger"></p>
    </div>
    <div class="contenedor__todo">
        <label for="exampleInputPassword1">Edita la Categoria</label>
        <input value="<?php echo isset($usuarios["categoria"]) ? $usuarios["categoria"] : ''; ?>" type="number" class="form-control bg-transparent p-4" name="categoria" placeholder="Edita la Categoria" />
        <p class="help-block text-danger"></p>
    </div>
    ...
    <div class="form-group">
        ...
        <input value="<?php echo isset($usuarios["estatus"]) ? $usuarios["estatus"] : ''; ?>" type="number" class="form-control bg-transparent p-4" name="estatus" placeholder="Edita el Estatus" />
        <p class="help-block text-danger"></p>
    </div>
